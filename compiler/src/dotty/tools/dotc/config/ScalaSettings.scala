...
private sealed trait YSettings:
  ...
  val YflexibleTypes: Setting[Boolean] = BooleanSetting("-Yflexible-types", "Make Java return types use flexible types. Flexible types essentially circumvent explicit nulls and force something resembling the old type system for Java interop.")
